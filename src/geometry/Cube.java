...
public class Cube extends Shape3D {
	...
	public Cube(Shape3D parent, double x, double y, double z) {
		...
		triangle3.setNormal(new Vecteur3D(0, 0, 1));
		...
		triangle4.setNormal(new Vecteur3D(0, 0, 1));
		...
		triangle5.setNormal(new Vecteur3D(0, -1, 0));
		...
		triangle6.setNormal(new Vecteur3D(0, -1, 0));
		...
		triangle7.setNormal(new Vecteur3D(0, 1, 0));
		...
		triangle8.setNormal(new Vecteur3D(0, 1, 0));
		...
		triangle9.setNormal(new Vecteur3D(-1, 0, 0));
		...
		triangle10.setNormal(new Vecteur3D(-1, 0, 0));
		...
		triangle11.setNormal(new Vecteur3D(1, 0, 0));
		...
		triangle12.setNormal(new Vecteur3D(1, 0, 0));
